 ...
 * Version: 1.2.3
 * Built: Fri Apr 05 2013 17:31:37
 * http://parse.com
 *
...
(function(root) {
  ...
  Parse.Cloud = {
    ...
    run: function(name, data, options) {
      ...
      var newOptions = _.clone(oldOptions);
      ...
      newOptions.error = Parse.Cloud._wrapError(oldOptions.error,
                                                options,
                                                promise);
    ...
    _wrapError: function(onError, options, promise) {
      return function(response) {
        var error = new Parse.Error(-1, response.responseText);
        if (response.responseText) {
          var errorJSON = JSON.parse(response.responseText);
